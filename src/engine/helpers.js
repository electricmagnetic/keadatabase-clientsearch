...
const processBirds = birds =>
  birds.filter(bird => bird.band_combo !== null)
  .map(bird => {
...
export { flattenTokens, getColours, getSymbols, getNames, getPrimaryBands, getStudyAreas, processBirds, getAllTokens, getCriteria, filterBirds };
